...
from MDTEformer_models.cross_encoder import Encoder
from MDTEformer_models.cross_decoder import Decoder
from MDTEformer_models.attn import FullAttention, AttentionLayer, TwoStageAttentionLayer
from MDTEformer_models.cross_embed import DSW_embedding

from math import ceil

class MDTEformer(nn.Module):
    def __init__(self, data_dim, in_len, out_len, seg_len, win_size = 4,
        ...
        super(MDTEformer, self).__init__()
